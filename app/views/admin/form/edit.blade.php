...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            ...
            {{Form::open(array('url' => URL::route('admin.nyomtatvany.update',array('id'=>$document->id)),'class'=>'form-horizontal','method'=>'PUT','files'=>true))}}
            ...
            <div class="box box-solid box-divide">
                <div class="box-header">
                    <h3 class="box-title">Nyomtatvány módosítása</h3>
                </div>
                <div class="box-body">
                    ...
                    <div class="form-group">
                        {{Form::label('file', 'Nyomtatvány',array('class'=>'col-lg-2 control-label'))}}
                        <div class="col-lg-9">
                            {{Form::input('file','file','',array('class'=>'form-control','placeholder'=>'Nyomtatvány'))}}
                        </div>
                    </div>
